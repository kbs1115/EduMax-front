...
// Styled components for the table and its elements
    ...
    <StyledTable>
      ...
      <StyledBody>
        ...
        {[...Array(10)].map((_, index) => (
          <StyledRow key={index}>
            <NumCell>
              <Typography size="body_content_medium" color="#393E46">{index + 1}</Typography>
            </NumCell>
            <SubjectCell>
              <StyledLink to="/some-path">
                <Typography size="body_content_thin">공지사항{index + 1}입니다</Typography>
              </StyledLink>
            </SubjectCell>
            <StyledCell>
            <Typography size="body_content_thin" color="#A8AAAE">윤규민</Typography>
